...
function SearchInput(
  { label, error, disabled, className, labelClassName, ...props }: Props,
  ref: ForwardedRef<HTMLInputElement>,
) {
  return (
    <label
      className={cn(
        "relative rounded-[36px] bg-gray-5 p-medium text-brand-green border-gray-40 border-[1px] flex items-center pl-[26px] pr-[64px] py-[12px]",
        labelClassName,
      )}
    >
      <input
